...
public class MainGUI extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.add( getJButtonTable());
	...
	private JButton getJButtonTable() {
		if (jButtonTable == null) {
			jButtonTable = new JButton();
			jButtonTable.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					int isLocal = 1;
					BLFacade blFacade = (new fabric.BLFactory()).createAppFace(isLocal);
			...
			jButtonTable.setText("Mireiak dituen apostuak");
		}
		return jButtonTable;
	}
