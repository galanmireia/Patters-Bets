	...
	public void initializeDB(){
		...
		try {
		   ...
		   if (month==12) { month=0; year+=1;}  
			...
			User u1 = new User("Mireia","Mireia","77777777N","Mireia", "Mireia", "Mireia");
			
			Apustua a1 = new Apustua(2, u1, q1, ev1);
			Apustua a2 = new Apustua(3, u1, q2, ev1);
			Apustua a3 = new Apustua(1, u1, q3, ev11);
			Apustua a4 = new Apustua(5, u1, q4, ev11);
			
			Vector<Apustua> a = new Vector<Apustua>();
			...
			u1.setErabiltzailearenApustuak(a);
...
public boolean existQuestion(Event event, String question) {
	...
	public void erregistratu(String izena, String pass, String NAN, String korreoa, String KZ,
		...
		TypedQuery<Event> query = db.createQuery("SELECT ev FROM Event ev WHERE ev.eventDate=?1",Event.class);   
		query.setParameter(1, date);
		EventsIterator<Event> ei = new EventsIterator(query.getResultList());
		return ei;
	}
